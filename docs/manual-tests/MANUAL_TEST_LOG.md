...
| 116 | Xác nhận vi phạm | ⬜ Chưa test | — | ⬜ **CHƯA TEST** | — | Kịch bản đã viết. **Cải chính audit gốc: "không refresh summary" là SAI — đã vá từ trước (2026-08-07).** Gap thật còn lại: không ghi audit log (gap chung cả module, ảnh hưởng đồng thời #116/#117/#118) |
| 117 | Bỏ qua vi phạm | ⬜ Chưa test | — | ⬜ **CHƯA TEST** | — | Kịch bản đã viết. 3 gap thật: không gửi notification nhân viên; không ghi audit (chung module); **gap nghiêm trọng nhất nhóm — bỏ qua vi phạm KHÔNG tự tắt affectsAttendance, bảng công vẫn coi như vi phạm đang ảnh hưởng dù HR đã quyết định bỏ qua** |
| 118 | Cập nhật ảnh hưởng công | ⬜ Chưa test | — | ⬜ **CHƯA TEST** | — | Kịch bản đã viết. Gap nghiêm trọng MỚI phát hiện: "chỉ sửa khi confirmed/pending" hoàn toàn KHÔNG được kiểm tra — code cố ý cho sửa affectsAttendance bất kỳ lúc nào (Javadoc xác nhận có chủ đích, không phải bug quên), mâu thuẫn trực tiếp với AC, cần chủ dự án quyết định. Refresh trigger đã đúng (violation_count literal không tồn tại). Audit log thiếu (chung module) |
