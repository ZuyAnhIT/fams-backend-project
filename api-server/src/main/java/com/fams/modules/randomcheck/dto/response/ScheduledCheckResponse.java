...
public class ScheduledCheckResponse {
    ...
    @Schema(description = "'auto' (generated by the nightly job) or 'manual_hr' (HR-triggered via "
            + "POST .../manual-check) — derived from triggeredBy (#108/#109, 2026-08-18), not a "
            + "separately stored field. Filterable via GET .../scheduled-checks?triggerType=")
