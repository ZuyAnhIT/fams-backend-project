...
public class RoleDetailResponse {
    ...
    // See RoleResponse for why @JsonProperty is required here — without it Jackson strips
    // "is" off isSystem()/isActive() and the frontend's isSystem/isActive fields are always
    // undefined.
